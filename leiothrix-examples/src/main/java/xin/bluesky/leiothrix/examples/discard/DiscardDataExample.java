package xin.bluesky.leiothrix.examples.discard;
 ...
 * @author 张轲
 */
public class DiscardDataExample {

    private static final Logger logger = LoggerFactory.getLogger(DiscardDataExample.class);
